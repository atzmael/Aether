	...
	add_bubble(parameterColor) {
		...
		switch (parameterColor) {
			case 'neutral':
				...
				break;
			case 'sadness':
                color.hue.min = this.map_range(220.0, 0.0, 360.0, 0.0, 1.0);
                color.hue.max = this.map_range(240.0, 0.0, 360.0, 0.0, 1.0);
			...
			case 'joy':
				...
				break;
			case 'fear':
                color.hue.min = this.map_range(142.0, 0.0, 360.0, 0.0, 1.0);
                color.hue.max = this.map_range(162.0, 0.0, 360.0, 0.0, 1.0);
                color.saturation.min = 0.4;
                color.lightness = 0.4;
				break;
        }
		...
		let material = new THREE.ShaderMaterial({
			...
			uniforms: {
				...
				uSaturationMin: { type: "f", value: color.saturation.min },
				uSaturationMax: { type: "f", value: color.saturation.max },
